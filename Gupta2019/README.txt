./<example_name> contains code to run each of the examples. ptempest (available here: https://github.com/RuleWorld/ptempest) is open source MATLAB software for Parallel Tempering, and is required to run the examples. key files in each of the example folders are:
